    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold mb-2">
          🗄️ Целевая <span className="text-[#ff6b00]">база данных</span>
        </h1>
        <p className="text-gray-400 mb-8">Управление списком конкурентов</p>

        <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-lg p-12 text-center">
          <div className="text-6xl mb-4">🎯</div>
          <p className="text-gray-400">База данных пуста. Добавьте первого конкурента.</p>
        </div>
      </div>
    </div>
  )
